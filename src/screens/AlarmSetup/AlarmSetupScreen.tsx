...
const AlarmSetupScreen = () => {
  ...
  const allSoundOptions = [
    ...
    {label: 'Ambient Piano', value: 'ambient-piano', description: 'Peaceful piano melody', preview: true, file: require('../../../assets/sounds/ambient_piano.mp3')},
    {label: 'Singing Bowl', value: 'singing-bowl', description: 'Peaceful Tibetan singing bowl tone', preview: true, file: require('../../../assets/sounds/singing_bowl.mp3')},
    {label: 'Singing Bowl Hit', value: 'singing-bowl-hit', description: 'Single singing bowl strike', preview: true, file: require('../../../assets/sounds/singing_bowl_hit.mp3')},
    {label: 'Tibetan Bowl Low', value: 'tibetan-bowl-low', description: 'Deep Tibetan bowl tone', preview: true, file: require('../../../assets/sounds/tibetan_bowl_low.mp3')},
    {label: 'Calm Music', value: 'calm-music', description: 'Soothing background music', preview: true, file: require('../../../assets/sounds/calm_music.mp3')},
    {label: 'Relaxing Guitar', value: 'relaxing-guitar', description: 'Gentle guitar melody', preview: true, file: require('../../../assets/sounds/relaxing_guitar.mp3')}
  ];
