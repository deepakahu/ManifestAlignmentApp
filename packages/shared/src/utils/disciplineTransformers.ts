...
export function goalFromDB(goalDB: GoalDB): Goal {
  return {
    ...
    specific: goalDB.specific,
    measurable: goalDB.measurable,
    achievable: goalDB.achievable,
    relevant: goalDB.relevant,
    timeBound: goalDB.time_bound,
    ...
    manualProgressOverride: goalDB.manual_progress_override,
...
export function activityFromDB(activityDB: DisciplineActivityDB): DisciplineActivity {
  return {
    ...
    reminderTime: activityDB.reminder_time,
...
export function competitionFromDB(competitionDB: DisciplineCompetitionDB): DisciplineCompetition {
  return {
    ...
    description: competitionDB.description,
